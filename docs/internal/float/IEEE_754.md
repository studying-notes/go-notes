...
![](../../../assets/images/docs/internal/float/IEEE_754/表2-1 数字的表示方法示例.png)
...
![](../../../assets/images/docs/internal/float/IEEE_754/表2-2 单精度与双精度浮点数格式.png)
...
![](../../../assets/images/docs/internal/float/IEEE_754/表2-3 数字0.085的单精度浮点数表示.png)
